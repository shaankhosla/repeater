...
- **Apple Notes integration** *(beta)*: drill cards written directly in Apple Notes — no file export needed. macOS only. Pass `--apple-notes` to `drill` or `check` (see the [docs](https://shaankhosla.github.io/repeater/commands.html)).
